...
import (
	...
	"github.com/Rabiann/weather-mailer/pkg/go/notification/internal/config"
...
func (m *MockMailingProvider) SendLetter(options external.MailOptions, ctx context.Context) error {
